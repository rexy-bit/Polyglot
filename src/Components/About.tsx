...
const About = () => {
    ...
    return(
        <section className="flex flex-col justify-center items-center bg-[#001f54] py-15" id="about">
            ...
            <h1 data-aos="fade-up" className="text-white font-bold text-[3em]">About <span className="text-blue-600 font-[poppins]">Polyglot</span></h1>

            <div data-aos="fade-up" className="flex flex-row justify-center items-center gap-50 px-10 mt-10 max-[1281px]:gap-30 max-[1050px]:gap-20 max-[900px]:flex-col max-[950px]:gap-10 ">
                <div className="flex flex-col gap-3 max-[950px]:items-center max-[950px]:gap-5">
                    ...
                    <div className="text-gray-200 text-[16px] w-[550px] max-[1200px]:w-[400px] max-[900px]:w-[300px] max-[900px]:text-center">
            ...
            <div data-aos="fade-up" className="flex flex-row justify-center items-center gap-30 px-10 mt-20 max-[1050px]:gap-20 max-[855px]:flex-col">
                <img src="/online.svg" className="w-[400px] max-[1050px]:w-[300px] order-1 max-[855px]:order-2" alt="" />
                <div className="flex flex-col gap-2 order-2 max-[855px]:order-1">
                    <p className="text-white font-bold text-[2.2em] max-[855px]:text-center">Our Mission</p>
                    <p className="text-gray-200 w-[500px] max-[1000px]:w-[400px] max-[450px]:w-[300px] max-[855px]:text-center">
  ...
  <strong>Join Polyglot Academy today</strong> and let your journey toward global communication begin.
                        ...
                        <div className="flex flex-row justify-center items-center gap-30 px-10 mt-20 max-[1050px]:gap-20 max-[855px]:flex-col" data-aos="fade-up">
                    ...
                    stats.map((s)=>{
                        return(
                            <div className="flex flex-col items-baseline max-[650px]:items-center">
                               <div><Counter end={s.num} duration={4000}/></div>  
